          ...
          <tr>
            <td style="background-color:#5B86E5;padding:30px;text-align:center;">
              <img
                ...
                alt="Chattio Logo"
                width="100"
                style="display:block;margin:0 auto 16px auto;border:0;height:auto;"
              />
          ...
          <tr>
            <td style="padding:32px;">
              ...
              <p style="font-size:13px;color:#555555;margin:0;">
                ...
                <a href="mailto:support@chattio.com" style="color:#5B86E5;text-decoration:underline;">contact support</a>.
              </p>
